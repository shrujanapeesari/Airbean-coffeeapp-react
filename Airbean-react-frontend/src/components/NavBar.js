      ...
      {closeNav && (
        <div className="sideNav">
          ...
          <div className="links">
            <ul>
              <li>
                <Link onClick={onClick} className="link" to="/menu">
                  Meny
                </Link>
              </li>
              <li>
                <hr></hr>
                <Link onClick={onClick} className="link" to="/about">
                  Vårt Kaffe
                </Link>
              </li>
              <li>
                <hr></hr>
                <Link onClick={onClick} className="link" to="/profile">
                  Min profil
                </Link>
              </li>
              <li>
                <hr></hr>
                <Link onClick={onClick} className="link" to="/order">
                  Orderstatus
                </Link>
                <hr></hr>
              </li>
